...
const SingleProduct = () => {
    ...
    return (
        <div>
            <PageHeader title = "Detalle del producto" currentPage = {<><Link to = "/shop">Tienda</Link>&nbsp;&nbsp; / &nbsp;&nbsp;Producto</>} />
                            ...
                            <div className = "col-lg-8 col-12">
                                <article>
                                    ...
                                    <div className = "review">
                                        {result.length > 0 && <Review detailedDescription = {result[0].detailedDescription} />}
                                    </div>
                                </article>
                            </div>
